          ...
          {generatedTicket ? (
            <div className="text-center space-y-4">
              ...
              <p className="text-slate-600 text-sm font-medium">
                Yêu cầu người mượn dùng điện thoại quét mã này để xác nhận.
              </p>
              <div className="pt-4 border-t border-slate-200">
                <p className="font-bold text-xl text-[#1a237e]">
                  {generatedTicket.borrowCode}
                </p>
                <p className="text-xs text-slate-400">Mã phiếu mượn</p>
              </div>
            </div>
          ) : (
        ...
        {!generatedTicket && (
          <div className="p-4 border-t bg-white flex gap-3">
            ...
            <button
              onClick={handleSave}
              disabled={isSaving}
              className="flex-1 py-3 bg-[#1a237e] text-white font-bold rounded-xl flex justify-center"
            >
